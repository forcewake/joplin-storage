...
*   [About the operation counting methodology](https://graphics.stanford.edu/~seander/#OperationCounting)
*   [Compute the sign of an integer](https://graphics.stanford.edu/~seander/#CopyIntegerSign)
*   [Detect if two integers have opposite signs](https://graphics.stanford.edu/~seander/#DetectOppositeSigns)
[](https://graphics.stanford.edu/~seander/#DetectOppositeSigns)*   [](https://graphics.stanford.edu/~seander/#DetectOppositeSigns)[Compute the integer absolute value (abs) without branching](https://graphics.stanford.edu/~seander/#IntegerAbs)
*   [Compute the minimum (min) or maximum (max) of two integers without branching](https://graphics.stanford.edu/~seander/#IntegerMinOrMax)
*   [Determining if an integer is a power of 2](https://graphics.stanford.edu/~seander/#DetermineIfPowerOf2)
*   Sign extending
    *   [Sign extending from a constant bit-width](https://graphics.stanford.edu/~seander/#FixedSignExtend)
    *   [Sign extending from a variable bit-width](https://graphics.stanford.edu/~seander/#VariableSignExtend)
    *   [Sign extending from a variable bit-width in 3 operations](https://graphics.stanford.edu/~seander/#VariableSignExtendRisky)
*   [Conditionally set or clear bits without branching](https://graphics.stanford.edu/~seander/#ConditionalSetOrClearBitsWithoutBranching)
*   [Conditionally negate a value without branching](https://graphics.stanford.edu/~seander/#ConditionalNegate)
*   [Merge bits from two values according to a mask](https://graphics.stanford.edu/~seander/#MaskedMerge)
*   Counting bits set
    *   [Counting bits set, naive way](https://graphics.stanford.edu/~seander/#CountBitsSetNaive)
    *   [Counting bits set by lookup table](https://graphics.stanford.edu/~seander/#CountBitsSetTable)
    *   [Counting bits set, Brian Kernighan's way](https://graphics.stanford.edu/~seander/#CountBitsSetKernighan)
    *   [Counting bits set in 14, 24, or 32-bit words using 64-bit instructions](https://graphics.stanford.edu/~seander/#CountBitsSet64)
    *   [Counting bits set, in parallel](https://graphics.stanford.edu/~seander/#CountBitsSetParallel)
    *   [Count bits set (rank) from the most-significant bit upto a given position](https://graphics.stanford.edu/~seander/#CountBitsFromMSBToPos)
    *   [Select the bit position (from the most-significant bit) with the given count (rank)](https://graphics.stanford.edu/~seander/#SelectPosFromMSBRank)
*   Computing parity (1 if an odd number of bits set, 0 otherwise)
    *   [Compute parity of a word the naive way](https://graphics.stanford.edu/~seander/#ParityNaive)
    *   [Compute parity by lookup table](https://graphics.stanford.edu/~seander/#ParityLookupTable)
    *   [Compute parity of a byte using 64-bit multiply and modulus division](https://graphics.stanford.edu/~seander/#ParityWith64Bits)
    *   [Compute parity of word with a multiply](https://graphics.stanford.edu/~seander/#ParityMultiply)
    *   [Compute parity in parallel](https://graphics.stanford.edu/~seander/#ParityParallel)
*   Swapping Values
    *   [Swapping values with subtraction and addition](https://graphics.stanford.edu/~seander/#SwappingValuesSubAdd)
    *   [Swapping values with XOR](https://graphics.stanford.edu/~seander/#SwappingValuesXOR)
    *   [Swapping individual bits with XOR](https://graphics.stanford.edu/~seander/#SwappingBitsXOR)
*   Reversing bit sequences
    *   [Reverse bits the obvious way](https://graphics.stanford.edu/~seander/#BitReverseObvious)
    *   [Reverse bits in word by lookup table](https://graphics.stanford.edu/~seander/#BitReverseTable)
    *   [Reverse the bits in a byte with 3 operations (64-bit multiply and modulus division)](https://graphics.stanford.edu/~seander/#ReverseByteWith64BitsDiv)
    *   [Reverse the bits in a byte with 4 operations (64-bit multiply, no division)](https://graphics.stanford.edu/~seander/#ReverseByteWith64Bits)
    *   [Reverse the bits in a byte with 7 operations (no 64-bit, only 32)](https://graphics.stanford.edu/~seander/#ReverseByteWith32Bits)
    *   [Reverse an N-bit quantity in parallel with 5 * lg(N) operations](https://graphics.stanford.edu/~seander/#ReverseParallel)
*   Modulus division (aka computing _remainders_)
    *   [Computing modulus division by 1 << s without a division operation (obvious)](https://graphics.stanford.edu/~seander/#ModulusDivisionEasy)
    *   [Computing modulus division by (1 << s) - 1 without a division operation](https://graphics.stanford.edu/~seander/#ModulusDivision)
    *   [Computing modulus division by (1 << s) - 1 in parallel without a division operation](https://graphics.stanford.edu/~seander/#ModulusDivisionParallel)
*   Finding integer log base 2 of an integer (aka the position of the highest bit set)
    *   [Find the log base 2 of an integer with the MSB N set in O(N) operations (the obvious way)](https://graphics.stanford.edu/~seander/#IntegerLogObvious)
    *   [Find the integer log base 2 of an integer with an 64-bit IEEE float](https://graphics.stanford.edu/~seander/#IntegerLogIEEE64Float)
    *   [Find the log base 2 of an integer with a lookup table](https://graphics.stanford.edu/~seander/#IntegerLogLookup)
    *   [Find the log base 2 of an N-bit integer in O(lg(N)) operations](https://graphics.stanford.edu/~seander/#IntegerLog)
    *   [Find the log base 2 of an N-bit integer in O(lg(N)) operations with multiply and lookup](https://graphics.stanford.edu/~seander/#IntegerLogDeBruijn)
*   [Find integer log base 10 of an integer](https://graphics.stanford.edu/~seander/#IntegerLog10)
*   [Find integer log base 10 of an integer the obvious way](https://graphics.stanford.edu/~seander/#IntegerLog10Obvious)
*   [Find integer log base 2 of a 32-bit IEEE float](https://graphics.stanford.edu/~seander/#IntegerLogFloat)
*   [Find integer log base 2 of the pow(2, r)-root of a 32-bit IEEE float (for unsigned integer r)](https://graphics.stanford.edu/~seander/#IntegerLogRootFloat)
*   Counting consecutive trailing zero bits (or finding bit indices)
    *   [Count the consecutive zero bits (trailing) on the right linearly](https://graphics.stanford.edu/~seander/#ZerosOnRightLinear)
    *   [Count the consecutive zero bits (trailing) on the right in parallel](https://graphics.stanford.edu/~seander/#ZerosOnRightParallel)
    *   [Count the consecutive zero bits (trailing) on the right by binary search](https://graphics.stanford.edu/~seander/#ZerosOnRightBinSearch)
    *   [Count the consecutive zero bits (trailing) on the right by casting to a float](https://graphics.stanford.edu/~seander/#ZerosOnRightFloatCast)
    *   [Count the consecutive zero bits (trailing) on the right with modulus division and lookup](https://graphics.stanford.edu/~seander/#ZerosOnRightModLookup)
    *   [Count the consecutive zero bits (trailing) on the right with multiply and lookup](https://graphics.stanford.edu/~seander/#ZerosOnRightMultLookup)
*   [Round up to the next highest power of 2 by float casting](https://graphics.stanford.edu/~seander/#RoundUpPowerOf2Float)
*   [Round up to the next highest power of 2](https://graphics.stanford.edu/~seander/#RoundUpPowerOf2)
*   Interleaving bits (aka computing _Morton Numbers_)
    *   [Interleave bits the obvious way](https://graphics.stanford.edu/~seander/#InterleaveTableObvious)
    *   [Interleave bits by table lookup](https://graphics.stanford.edu/~seander/#InterleaveTableLookup)
    *   [Interleave bits with 64-bit multiply](https://graphics.stanford.edu/~seander/#Interleave64bitOps)
    *   [Interleave bits by Binary Magic Numbers](https://graphics.stanford.edu/~seander/#InterleaveBMN)
*   Testing for ranges of bytes in a word (and counting occurances found)
    *   [Determine if a word has a zero byte](https://graphics.stanford.edu/~seander/#ZeroInWord)
    *   [Determine if a word has a byte equal to n](https://graphics.stanford.edu/~seander/#ValueInWord)
    *   [Determine if a word has byte less than n](https://graphics.stanford.edu/~seander/#HasLessInWord)
    *   [Determine if a word has a byte greater than n](https://graphics.stanford.edu/~seander/#HasMoreInWord)
    *   [Determine if a word has a byte between m and n](https://graphics.stanford.edu/~seander/#HasBetweenInWord)
*   [Compute the lexicographically next bit permutation](https://graphics.stanford.edu/~seander/#NextBitPermutation)
...
&                                                                                       1111 1111
\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-
                                                                                        hgfe dcba Note that the last two steps can be combined on some processors because the registers can be accessed as bytes; just multiply so that a register stores the upper 32 bits of the result and the take the low byte. Thus, it may take only 6 operations.
...
Eric Cole devised this January 8, 2006 after reading about the entry below to [round up to a power of 2](https://graphics.stanford.edu/~seander/#RoundUpPowerOf2) and the method below for [computing the number of trailing bits with a multiply and lookup](https://graphics.stanford.edu/~seander/#ZerosOnRightMultLookup) using a DeBruijn sequence. On December 10, 2009, Mark Dickinson shaved off a couple operations by requiring v be rounded up to one less than the next power of 2 rather than the power of 2.
...
{ // subnormal, so recompute using mantissa: c = intlog2(x) - 149;
  ...
  // Note that LogTable256 was defined [earlier](https://graphics.stanford.edu/~seander/#IntegerLogLookup)
  if (t = x >> 16)
  {
    c = LogTable256\[t\] - 133;
  }
...
Although the quick and dirty version only uses around 6 operations, it is roughly three times slower than the [technique below](https://graphics.stanford.edu/~seander/#RoundUpPowerOf2) (which involves 12 operations) when benchmarked on an Athlon™ XP 2100+ CPU. Some CPUs will fare better with it, though.
...
There is yet a faster method — use [`hasless`](https://graphics.stanford.edu/~seander/#HasLessInWord)(v, 1), which is defined below; it works in 4 operations and requires no subsquent verification. It simplifies to
