JavaScript_и_браузер_Хабрахабр

Source [http://habrahabr.ru/post/243311/](http://habrahabr.ru/post/243311/)

# JavaScript и браузер / Хабрахабр

#### Содержание

_Браузер – крайне враждебная программная среда_
...
, который показывает картинку, находящуюся по заданному адресу URL.
